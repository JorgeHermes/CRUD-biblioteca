...
namespace CRUDbiblioteca {
    ...
    public partial class bibliotecaDataSet : global::System.Data.DataSet {
        ...
        public partial class clienteDataTable : global::System.Data.TypedTableBase<clienteRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public clienteRow AddclienteRow(string nome, string cpf, string email, string tipoCliente, string telefone) {
...
namespace CRUDbiblioteca.bibliotecaDataSet1TableAdapters {
    ...
    public partial class clienteTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[cliente] ([nome], [cpf], [email], [tipoCliente], [telefone]) V" +
                "ALUES (@nome, @cpf, @email, @tipoCliente, @telefone);\r\nSELECT idCliente, nome, c" +
                "pf, email, tipoCliente, telefone FROM cliente WHERE (idCliente = SCOPE_IDENTITY(" +
                "))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[cliente] SET [nome] = @nome, [cpf] = @cpf, [email] = @email, [tipoCliente] = @tipoCliente, [telefone] = @telefone WHERE (([idCliente] = @Original_idCliente) AND ([nome] = @Original_nome) AND ([cpf] = @Original_cpf) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)) AND ([tipoCliente] = @Original_tipoCliente) AND ((@IsNull_telefone = 1 AND [telefone] IS NULL) OR ([telefone] = @Original_telefone)));
SELECT idCliente, nome, cpf, email, tipoCliente, telefone FROM cliente WHERE (idCliente = @idCliente)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CRUDbiblioteca.Properties.Settings.Default.bibliotecaConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT idCliente, nome, cpf, email, tipoCliente, telefone FROM dbo.cliente";
        ...
        public virtual int Delete(int Original_idCliente, string Original_nome, string Original_cpf, string Original_email, string Original_tipoCliente, string Original_telefone) {
            ...
            if ((Original_tipoCliente == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[5].Value = ((string)(Original_tipoCliente));
            }
        ...
        public virtual int Insert(string nome, string cpf, string email, string tipoCliente, string telefone) {
            if ((nome == null)) {
            ...
            if ((tipoCliente == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[3].Value = ((string)(tipoCliente));
            }
            if ((telefone == null)) {
        ...
        public virtual int Update(string nome, string cpf, string email, string tipoCliente, string telefone, int Original_idCliente, string Original_nome, string Original_cpf, string Original_email, string Original_tipoCliente, string Original_telefone, int idCliente) {
            if ((nome == null)) {
                throw new global::System.ArgumentNullException("nome");
            }
            else {
            ...
            if ((tipoCliente == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[3].Value = ((string)(tipoCliente));
            }
            if ((telefone == null)) {
            ...
            if ((Original_tipoCliente == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[10].Value = ((string)(Original_tipoCliente));
            }
            if ((Original_telefone == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string nome, string cpf, string email, string tipoCliente, string telefone, int Original_idCliente, string Original_nome, string Original_cpf, string Original_email, string Original_tipoCliente, string Original_telefone) {
            return this.Update(nome, cpf, email, tipoCliente, telefone, Original_idCliente, Original_nome, Original_cpf, Original_email, Original_tipoCliente, Original_telefone, Original_idCliente);
        }
    }
